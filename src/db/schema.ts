...
export const requestSchemaId = selectTaskSchema.pick({ id: true });
export const requestSchemaText = selectTaskSchema.pick({ text: true });
...
export type TTaskId = typeof requestSchemaId._type.id;
export type TTaskText = typeof requestSchemaText._type.text;
